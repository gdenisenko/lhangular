myApp.controller('rxmsCntrl', ['$scope', '$location', function($scope, $location) {
	/*
	$scope.myData1 = [{id : 1, rxmGroupName : 'A', rxmGroup:'SGC30031', rxmName : 'E', rxmNumber:'C0123450', dailyNetDV01 : '12000', dailyCrossDV01 : '25', aggNetDV01 : '$400,000.0'},
	...
	*/
	$scope.myData = rxmsDataArr;
	$scope.gridOptions = {
			data : 'myData',
			columnDefs : [{field : 'rxmGroupName', displayName : 'RXM Group Name', width : 250},
			              {field : 'rxmGroup', displayName : 'RXM Group Number', width : 100},
			              {field : 'rxmName', displayName : 'RXM Name', width : 250},
...
myApp.controller('rxmDetailsCntrl', ['$scope', '$routeParams', function($scope, $routeParams) {	
	rxmNumber = $routeParams.rxmNumber;
	...
	$scope.gridOptions = {
			...
			multiSelect: false,
			showColumnMenu:true,
			filterOptions: {filterText:'RXM Number:' + rxmNumber, useExternalFilter: false}, 
			columnDefs: [      
